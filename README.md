...
git clone https://github.com/AwesomeKid99999/awesomekid99999.github.io.git

# Navigate into the directory
cd awesomekid99999.github.io
...
http://localhost:8000
```
If you want other devices on your local network to connect, instead do:
```bash
python -m http.server 8000 --bind 0.0.0.0
# On another device: http://<your_lan_ip>:8000
```
after navigating into the directory.

---

This site will be continuously maintained for the future.
